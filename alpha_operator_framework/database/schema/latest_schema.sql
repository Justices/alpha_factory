...
CREATE TABLE IF NOT EXISTS template_prune_rules (
 id INTEGER PRIMARY KEY AUTOINCREMENT, pattern TEXT NOT NULL, pattern_type TEXT NOT NULL DEFAULT 'prefix',
 family TEXT NOT NULL DEFAULT '', reason TEXT NOT NULL DEFAULT '', source TEXT NOT NULL DEFAULT 'static',
